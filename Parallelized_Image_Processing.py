    ...
    if __name__ == '__main__':
        ...
        for i in range(len(list_of_images)):
            save_location = os.path.dirname((os.path.dirname(input_dir))) + "/" + str(list_of_images[i][0]).replace('.', '_') + "_" + list_of_images[i][
                1] + "_" + list_of_images[i][2] + "_" + str(list_of_images[i][3]) + "_" + str(list_of_images[i][4]) + "_" + str(downsampling_factor) + "/tifs"
        ...
        for i in range(num_batches):
            ...
            output_file = os.path.join(os.path.dirname(((input_dir))) + "/" + str(list_of_images[-1][0]).replace('.', '_') + "_" + list_of_images[-1][1] + "_" + list_of_images[-1][2] + "_" + str(list_of_images[-1][3]) + "_" + str(list_of_images[i][4]) + "_" + str(downsampling_factor) + "/VideoChunks", "output" + str(i).zfill(4) + ".mp4")
            print(output_file)
            if not (os.path.exists(output_file)):
                ...
                results = pool.starmap(process_files, zip(file_paths, [input_dir] * len(file_paths), [file_dict] * len(file_paths), [list_of_images] * len(file_paths), [save_images] * len(file_paths), [make_movie] * len(file_paths), [downsampling_factor] * len(file_paths)))

                pool.close()
                pool.join()

                if make_movie:
                    if not (os.path.exists(os.path.dirname(((input_dir))) + "/" + str(list_of_images[-1][0]).replace('.', '_') + "_" + list_of_images[-1][1] + "_" + list_of_images[-1][2] + "_" + str(list_of_images[-1][3]) + "_" + str(list_of_images[i][4]) + "_" + str(downsampling_factor) + "/VideoChunks")):
                        os.makedirs(os.path.dirname(((input_dir))) + "/" + str(list_of_images[-1][0]).replace('.', '_') + "_" + list_of_images[-1][1] + "_" + list_of_images[-1][2] + "_" + str(list_of_images[-1][3]) + "_" + str(list_of_images[i][4]) + "_" + str(downsampling_factor) + "/VideoChunks")
                    #print(output_file)
                    try:
        ...
        if make_movie:
            ...
            files = os.listdir(os.path.dirname(((input_dir))) + "/" + str(list_of_images[-1][0]).replace('.', '_') + "_" + list_of_images[-1][1] + "_" + list_of_images[-1][2] + "_" + str(list_of_images[-1][3]) + "_" + str(list_of_images[i][4]) + "_" + str(downsampling_factor) + "/VideoChunks")
            ...
            for mp4_file in mp4_files:
                file_path = os.path.join(os.path.dirname(((input_dir))) + "/" + str(list_of_images[-1][0]).replace('.', '_') + "_" + list_of_images[-1][1] + "_" + list_of_images[-1][2] + "_" + str(list_of_images[-1][3]) + "_" + str(list_of_images[i][4]) + "_" + str(downsampling_factor) + "/VideoChunks", mp4_file)
            ...
            output_path = (os.path.dirname(((input_dir))) + "/" + str(list_of_images[-1][0]).replace('.', '_') + "_" + list_of_images[-1][1] + "_" + list_of_images[-1][2] + "_" + str(list_of_images[-1][3]) + "_" + str(list_of_images[i][4]) + "_" + str(downsampling_factor) + "_VideoClip_" + "fps" + str(fps) + ".mp4")
...
source_path='/home/gtb2115/syn01/cuttlefish/CUTTLEFISH_BEHAVIOR/2023_BEHAVIOR/E-ink_Tank/2023-07-05_Tom_Quilt_51_25q-120s_26b-120s_alt_c2023-04-21/DCIM/'
...
list_of_images = [[1, "raw", "color", 0, "flip"]]
